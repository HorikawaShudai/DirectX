...
{
	g_Bool.Homing = false;
	g_Camera.posV = D3DXVECTOR3(0.0f,110.0f,-300.0f);
	g_Camera.posR = D3DXVECTOR3(0.0f, 44.0f, 0.0f);
	...
	g_Camera.Length = 100.0f;
	g_Camera.LengthR = 20.0f;
...
void UpdataCamera(void)
{
	...
	/*
		...
		*/
		...
		//		g_Camera.rot.y = -D3DX_PI;
		//	}
		//	g_Camera.posR.z = g_Camera.posV.z + sinf(g_Camera.rot.y)* g_Camera.Length;
		//	g_Camera.posR.x = g_Camera.posV.x + cosf(g_Camera.rot.y)* g_Camera.Length;
		//}
